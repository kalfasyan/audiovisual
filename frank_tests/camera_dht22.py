...
with picamera.PiCamera() as camera:
    ...
    filepath = "/home/pi/Documents/Images/" + getdatetime("year") + getdatetime("month") + getdatetime("day") + getdatetime("hour") + getdatetime("minute") + getdatetime("second")+ "_"+ stringtemperature+ '_' + stringhumidity +".jpg"
    print (filepath)
